...
//   ]
// }
async function generateCircuit(final_graph, circuitLibPath, circuitName) {
  //   const graph_json = lexical.compile(regex);
  //   const N = graph_json.length;

  //   given graph, rev_graph, accepted_states
  ...
  assert.strictEqual(accepted_states.has(0), false);
  ...
  if (OUTPUT_HALO2) {
    console.log(
      "Logging to halo2 file! Note that this file is not formatted correctly. For the latest spec, see https://github.com/zkemail/halo2-regex"
    );
